...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative mt-20 border-t border-white/10 bg-black">
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_top,_rgba(99,102,241,0.1),transparent_50%)]" />
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full border border-white/20 bg-white/10 shadow-lg backdrop-blur-sm">
          ...
          <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
            ...
            <div className="flex items-center gap-4">
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-9 w-9 items-center justify-center rounded-full border border-white/15 bg-white/10 text-white/70 transition-all hover:border-orange-500/50 hover:text-orange-400"
                aria-label="GitHub"
