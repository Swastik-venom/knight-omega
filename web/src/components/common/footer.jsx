      ...
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground max-w-sm mb-4">
              The ultimate AI API gateway. Seamlessly access 50+ leading AI models through a single, unified API.
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/console/playground" className="text-muted-foreground hover:text-foreground transition-colors">
                  Playground
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/user-agreement" className="text-muted-foreground hover:text-foreground transition-colors">
                  User Agreement
                </Link>
              </li>
              <li>
                <a href="mailto:support@quantumnous.com" className="text-muted-foreground hover:text-foreground transition-colors">
                  Contact
                </a>
              </li>
            </ul>
        ...
        <div className="border-t border-border/50 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            ...
            <Link to="/user-agreement" className="text-muted-foreground hover:text-foreground transition-colors text-sm">
              Terms
            </Link>
          </div>
        </div>
